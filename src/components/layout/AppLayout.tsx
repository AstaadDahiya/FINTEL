            ...
            <SidebarMenu>
              ...
              <SidebarMenuItem>
                <Link href="/learn" passHref>
                  <SidebarMenuButton tooltip="Learn" isActive={isActive('/learn')}>
                    <BookOpen />
                    <span>Learn</span>
                  </SidebarMenuButton>
                </Link>
              ...
              <SidebarMenuItem>
                <Link href="/simulator" passHref>
                  <SidebarMenuButton tooltip="Simulator" isActive={isActive('/simulator')}>
                    <LineChart />
                    <span>Simulator</span>
                  </SidebarMenuButton>
                </Link>
              ...
              <SidebarMenuItem>
                <Link href="/insights" passHref>
                  <SidebarMenuButton tooltip="AI Insights" isActive={isActive('/insights')}>
                    <Sparkles />
              ...
              <SidebarMenuItem>
                <Link href="/summarizer" passHref>
                  <SidebarMenuButton tooltip="Summarizer" isActive={isActive('/summarizer')}>
                    <TextSelect />
            ...
            <SidebarMenu>
                <SidebarMenuItem>
                  <Link href="/support" passHref>
                    <SidebarMenuButton tooltip="Support" isActive={isActive('/support')}>
                      <HelpCircle />
                      <span>Support</span>
                    </SidebarMenuButton>
                  </Link>
